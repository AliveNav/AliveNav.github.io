...
function randomNumberGenerator() {
  ...
  firstLine.addClass("firstLineAfter");
...
function check() {
  ...
  if (random == counter) {
    ...
    firstLine.removeClass("firstLineAfter");
    firstLine.addClass("firstLine");
    $("#valuebtn").prop("disabled", false);
  } else {
    firstLine.html(counter);
    $("#randomNumber").html(" &ne; " + random);
    $("#randomNumber").html();
    secondLine.html("Deine Antwort ist leider falsch!");

    firstLine.removeClass("firstLineAfter");
    firstLine.addClass("firstLineFalsch");
  }
}
