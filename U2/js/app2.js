...
$("#down").droppable({
  ...
  drop: function (event, ui) {
    ...
    if (!ui.draggable.hasClass("canvas-element")) { //ui is the draggable object
...
$("#dropbox-merge").droppable({
  ...
  drop: function (event, ui) {
    ...
    if(start_counting_in_merge_area){
      ...
      firstLine.html(`<span class="black-line-mid"> Stelle die Zahl </span><span class="color-line-big">${random} </span><span class="black-line-mid"> mit den Materialien dar! </span>`);
      $("#randomNumber").html("");
      secondLine.html("");
      }
      if (counterZehner == 10) {
    ...
    if(!start_counting_in_merge_area){ // if merge area is hidden
...
function check() {
  ...
  <span class="color-line-big" id="span1">${counter_1_total}</span> <span class="black-line-mid" id="span1">Einer</span> verwendet.</span>`);
    secondLine.html(
      `<span class="black-line-mid">Bündel und lege die Zahl <span class="color-line-big"> ${random}</span>  mit weniger Teilen.</span>`
    );
...
function sortElements() {
  ...
  sort_row(el1000,el1000_width,el1000_height,spaceX,height1,el1000length,gapeX,dropBoxWidth,dropBoxHeight,positionLeft,positionTop);
  sort_row(el100,el100_width,el100_height,spaceX,height2,el100length,gapeX,dropBoxWidth,dropBoxHeight,positionLeft,positionTop);
  sort_row(el10,el10_width,el10_height,spaceX,height3,el10length,gapeX,dropBoxWidth,dropBoxHeight,positionLeft,positionTop);
  sort_row(el1,el1_width,el1_height,spaceX,height4,el1length,gapeX,dropBoxWidth,dropBoxHeight,positionLeft,positionTop);
